...
class Ui_MainWindow(object):
    ...
    def retranslateUi(self, MainWindow):
        ...
        self.save_reports_button.setToolTip(QtGui.QApplication.translate("MainWindow", "<html><head/><body><p><span style=\" font-weight:600;\">Save constrains and evaluated scoring reports on *.xls file</span></p></body></html>", None, QtGui.QApplication.UnicodeUTF8))
        self.save_reports_button.setText(QtGui.QApplication.translate("MainWindow", "Save Reports", None, QtGui.QApplication.UnicodeUTF8))
        self.listWidget.setToolTip(QtGui.QApplication.translate("MainWindow", "<html><head/><body><p><span style=\" font-weight:600;\">Import plan data - set the folder containing RP,RS,RD dicom files</span></p></body></html>", None, QtGui.QApplication.UnicodeUTF8))
        self.label.setText(QtGui.QApplication.translate("MainWindow", "<html><head/><body><p align=\"center\"><span style=\" font-weight:600;\">Participant\'s name</span></p></body></html>", None, QtGui.QApplication.UnicodeUTF8))
        self.import_button.setToolTip(QtGui.QApplication.translate("MainWindow", "<html><head/><body><p><span style=\" font-weight:600;\">Import plan data - set the folder containing RP,RS,RD dicom files</span></p></body></html>", None, QtGui.QApplication.UnicodeUTF8))
