...
if __name__ == '__main__':
    ...
    rtss = r'/home/victor/Dropbox/Plan_Competition_Project/gui/cases/BrainMetSRSCase/GTV/RS.dcm'
    rt_dose = '/home/victor/Dropbox/Plan_Competition_Project/tests/tests_data/GK_plan_GTV/RTDOSE0000000021.dcm'
    ini_file = '/home/victor/Dropbox/Plan_Competition_Project/gui/cases/BrainMetSRSCase/GTV/PyPlanScoring.ini'
    ...
    # criteria file
    file_path = '/home/victor/Dropbox/Plan_Competition_Project/gui/cases/BrainMetSRSCase/GTV/Scoring_criteria.xlsx'
    ...
    dvh_all = [dvh_data[6],
               ...
               dvh_data[9],
               dvh_data[10]]
    dvh_items = [DVHMetrics(d) for d in dvh_all]
    dvh_total = sum(dvh_items)
    dvh_total_dict = dvh_total.dvh_data
    dvh_total_dict['name'] = 'GTV_ALL'
    dvh_data[11] = dvh_total_dict
    planning_obj.dvh_data = dvh_data
